              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                {selectedPlan && (
                  <div className="shrink-0">
                    <span className="inline-block text-xs font-bold uppercase tracking-wider bg-purple-600/20 text-purple-400 border border-purple-600/40 rounded-full px-3 py-1.5">
              ...
              {step === 1 && (
                <form onSubmit={handleStep1} className="space-y-4 mt-6">
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      type="submit"
                      className="flex-1 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white rounded-xl py-3 font-semibold text-sm transition-all shadow-lg shadow-purple-900/40"
                    >
                      Next Step →
                    </button>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 mt-6">
                  ...
                  <Field label="Logo" hint="PNG or JPG, max 2 MB">
                    ...
                    <button
                      ...
                      className="w-full bg-gray-900/60 border border-gray-700/80 rounded-xl px-4 py-2.5 text-sm text-gray-400 hover:border-purple-500 transition-colors text-left flex items-center gap-2"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="flex-1 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white rounded-xl py-3 font-semibold text-sm transition-all shadow-lg shadow-purple-900/40 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                      {loading ? (
                        <>
